...
const updateFood = catchAsync(async (req: Request, res: Response) => {
  const result = await FoodServices.updateFood(
...
const deleteFood = catchAsync(async (req: Request, res: Response) => {
  const result = await FoodServices.deleteFood(req.params.id as string);
...
const getSingleFood = catchAsync(async (req: Request, res: Response) => {
  const result = await FoodServices.getSingleFoodById(req.params.id as string);
